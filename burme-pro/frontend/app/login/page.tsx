    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400">Sign in to Burme Editing Pro</p>
        </div>
        ...
        <div className="bg-card border border-cyan-500/20 rounded-2xl p-6">
          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-[#0a0e17] border border-cyan-500/20 rounded-xl pl-10 pr-4 py-3 focus:outline-none focus:border-cyan-500"
                  required
                />
              </div>
            </div>
            ...
            <Button variant="neon" size="lg" className="w-full" type="submit" loading={loading}>
